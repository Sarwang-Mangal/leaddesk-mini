...
export default function AdminPage() {
  ...
  const fetchLeads = useCallback(async (q: string, status: string) => {
    setLoading(true);
    setFetchError(null);
    try {
      ...
      setFetchError('Could not load leads. Please refresh the page to try again.');
    } finally {
      setLoading(false);
    }
  }, []);
